...
[spc, brd] = binning(di);
spc_path = '/Users/jtolento/RRTMG_SW/run_examples_std_atm/ppr1/clr/input_trp_spc';  % Replace with the actual file path
brd_path = '/Users/jtolento/RRTMG_SW/run_examples_std_atm/ppr1/clr/input_trp_brd';
...
[spc, brd] = binning(di);
spc_path = '/Users/jtolento/RRTMG_SW/run_examples_std_atm/ppr1/cld/input_trp_spc';  % Replace with the actual file path
brd_path = '/Users/jtolento/RRTMG_SW/run_examples_std_atm/ppr1/cld/input_trp_brd';
binned_albedo = spc;  % Replace with your binned albedo values
line = 7;          %7 for direct, 8 for diffuse
modify_rrtm_input(spc_path, spc,line);
modify_rrtm_input(brd_path, brd,line)
