...
input_args.dz = [0.09, 1.12, 1000]; % multi layer column 
...
input_args.rho_snw(1:nbr_lyr) = [1000, 915, 1000]; 
...
zmosaic_var1 = readmatrix('mosaic_data.xlsx', 'Range','B11:B2015');
...
if (1==1)
    ...
    plot(di.wvl,di.albedo,'linewidth',3, 'DisplayName','SNICAR4');
    plot(di.wvl,ds.albedo,'linewidth',3, 'DisplayName','SNICAR4 SSL');
    axis([0.2 2.6 0 1]);
    set(gca,'xtick',0.2:0.5:5,'fontsize',14)
    set(gca,'ytick',0:0.1:1.0,'fontsize',14);
    xlabel('Wavelength (\mum)','fontsize',20);
